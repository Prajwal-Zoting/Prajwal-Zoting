...
class complex_num {
    ...
    void display() 
    {
        System.out.println("\t Complex nun is: " + real + "+" + imaginary + "i"); // Displays the complex number in this
                                                                                  // specified format
    }
    ...
    void add(complex_num c1, complex_num c2) // this function adds the complex num in specified format and stores the
                                             // real value in the real part of complex no and same i
    {
        real = c1.real + c2.real;
        imaginary = c2.imaginary + c1.imaginary;
    }

    void subtract(complex_num c1, complex_num c2)// performs subtraction of complex nues
    {
        real = c1.real - c2.real;
        imaginary = c2.imaginary - c1.imaginary;
    }
    ...
    void division(complex_num c1, complex_num c2) {
...
public class Complexfinal {
    public static void main(String[] args) {
        ...
        do
        {
        System.out.println("Enter - 0) Change complex no 1) Add, 2)Substract, 3)Multiply, 4)Divide");
            d=sp.nextInt();
        switch (d) {
            case 0:
                System.out.println("Enter first complex num -");
